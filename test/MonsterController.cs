...
{    /**
    ...
    public class MonsterController
    {
        ...
        private Dictionary<string, object> classNameCounts;
        ...
        public MonsterController(/*<var>*/dynamic view)
        {
            ...
            classNameCounts = new Dictionary<string, object>(){
         ...
         */
        internal Dictionary<string, object> Create(/*<var>*/dynamic child, string key, /*<var>*/dynamic change)
        {
            if (child)
            {}
            else
